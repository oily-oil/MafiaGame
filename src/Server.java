        ...
        public void run() {
            try {
                ...
                while ((line = in.readLine()) != null) {
                    ...
                    if (message.startsWith("TIMER:")) continue;
                    ...
                    if (message.equalsIgnoreCase("/start")) {
                        ...
                        switch (role){
                            case POLICE:
                                handleInvestigate(this, message);
                                break;
                            case DOCTOR:
                                handleSave(this, message);
                                break;
                            case MAFIA:
                                handleKillCommand(this, message);
                                break;
                            case CITIZEN:
